...
function pokemonGrandeDreamTeam() {
    ...
    const dreamTeamOrdenadoTamano = [...datosGenerales.dreamTeam].sort((a, b) => a.altura - b.altura);
...
function pokemonPequenoDreamTeam() {
    ...
    const dreamTeamOrdenadoNumero = [...datosGenerales.dreamTeam].sort((a, b) => a.numero - b.numero);
...
document.addEventListener("click", (e) => {
    if (window.location.pathname.endsWith("dream-team.html")) {
        ...
        if (target.classList.contains("eliminar-dream-team") ||
            ...
            if (!target.classList.contains("eliminar-dream-team")) {
                target = target.closest(".eliminar-dream-team");
            }
...
export function modificarPokemonDreamTeamDesdeCarta(nombre, icono) {
...
export function sumarAlDreamTeamDesdeCarta(pokemon, icono) {
    funcionesGenerales.sumarAlDreamTeam(pokemon);
    icono.classList.add("activo");
}
export function quitarDelDreamTeamDesdeCarta(pokemon, icono) {
    funcionesGenerales.quitarDelDreamTeam(pokemon);
