...
export function mostrarPokemon(pokemon, dreamTeam) {
    const htmlDreamTeam = `
...
export function mostrarNoHayResultado() {
    ...
    if (container != null) {
        funcionesGenerales.vaciarHtmlConId("resultado-busqueda");
        funcionesGenerales.meterAlHtmlConId("resultado-busqueda", htmlNoHayResultado);
    }
}
export function mostrarErrorAPI() {
  ...
  `;
    if (container != null) {
        funcionesGenerales.vaciarHtmlConId("resultado-busqueda");
        funcionesGenerales.meterAlHtmlConId("resultado-busqueda", htmlErrorAPI);
    }
}
